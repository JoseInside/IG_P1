...
class CTex2 {
public:
	CTex2(GLdouble s = 0.0, GLdouble t = 0.0): s(s), t(t) {};
	~CTex2() {};

	GLdouble s, t;
	void set(GLdouble ps, GLdouble pt) { s = ps; t = pt; };
};
...
class Color4 {
public:
	Color4(GLdouble r = 0.0, GLdouble g = 0.0, GLdouble b = 0.0, GLdouble a = 0.0) : r(r), g(g), b(b), a(a) {};
	~Color4() {};

	GLdouble r, g, b, a;
	void set(GLdouble pr, GLdouble pg, GLdouble pb, GLdouble pa) { r = pr; g = pg; b = pb; a = pa; };
};
//-------------------------------------------------------------------------
#endif //_H_tipos_H_